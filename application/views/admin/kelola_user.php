    ...
    <div class="span12">
      <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <a class="btn btn-default" href="<?php echo site_url('Admin/tambah_user') ?>">Tambah User</a>
	            ...
	            <tbody>
					...
					<?php foreach ($user as $key) { ?>
						<tr>
							...
							<td>
								<a class="btn btn-primary" href="<?php echo site_url('Admin/edit_user/'.$key->id_user) ?>">Edit</a>
								<a class="btn btn-danger" href="<?php echo site_url('Admin/delete_user/'.$key->id_user) ?>">Delete</a>
							</td>
							<?php $no++ ?>
						</tr>
					<?php } ?>
