...
<div id="content">
  ...
  <div class="container-fluid">
      <h3>Tambah Data Jagung Tahun <?php echo $this->uri->segment(3) ?></h3>
    <div class="row-fluid">
    <div class="span12">
      <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <?php echo form_open('Admin/tambah_jagung/'.$this->uri->segment(3),array(
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" name="produksi" id="produksi" placeholder="Produksi" required>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Luas Panen :</label>
                <div class="controls">
                  <input type="text" class="span11" name="luas_panen" id="luas_panen" placeholder="Luas Panen" required>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Produktivitas :</label>
                <div class="controls">
                  <input type="text" class="span11" name="produktivitas" id="produktivitas" placeholder="Produktivitas" required>
                </div>
              </div>
