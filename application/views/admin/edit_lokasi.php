        ...
        <div class="widget-content">
          <div class="row-fluid">
            <div class="widget-content nopadding">
              <?php echo form_open('Admin/edit_lokasi/'.$this->uri->segment(3),array(
              ...
              <?php foreach ($lokasi as $key) { ?>
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="span11" name="nama_lokasi" id="nama_lokasi" value="<?php echo $key->nama_lokasi ?>" placeholder="Lokasi" required>
                  </div>
                </div>
              <?php } ?>
